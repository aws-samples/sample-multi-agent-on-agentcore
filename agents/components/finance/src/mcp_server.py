"""Finance MCP Server - Finance agent wrapped in MCP protocol."""
...
def finance_agent(query: str) -> str:
    """Handle finance queries including expense report submissions and status, department budget summaries and utilization, invoice status and vendor payments, and reimbursement tracking. Use this agent for anything related to expenses, budgets, or financial reporting."""
    username = get_current_username()
    logger.info(f"finance_agent called: username={username}")
